...
public class ChattingDto {
    ...
    @Builder
    public ChattingDto(Long idx, Long chattingRoomIdx, Long fileIdx, String message, Timestamp registDate, Long register, Long registerProfileIdx, String registerName) {
        this.idx = idx;
